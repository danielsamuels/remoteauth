...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rank.price'
        db.alter_column('ranks_rank', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rank.price'
        db.alter_column('ranks_rank', 'price', self.gf('django.db.models.fields.FloatField')(max_length=100))
